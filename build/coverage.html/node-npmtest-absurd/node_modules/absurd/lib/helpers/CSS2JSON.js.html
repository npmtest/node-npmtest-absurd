...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-absurd/node_modules/absurd/lib/helpers/CSS2JSON.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-absurd/node_modules/absurd/lib/helpers/CSS2JSON.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62.96% <small>(51 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">62.96% <small>(51 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-absurd/node_modules/absurd/lib/helpers/</a> &#187; CSS2JSON.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Copyright (C) 2011 Google Inc.
//
...
&nbsp;
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  function decodeCssEscape(s) {</span>
<span class="cstat-no" title="statement not covered" >    var i = parseInt(s.substring(1), 16);</span>
...
<span class="cstat-no" title="statement not covered" >    if (i &gt; 0xffff) {</span>
      // A supplemental codepoint.
<span class="cstat-no" title="statement not covered" >      return i -= 0x10000,</span>
        String.fromCharCode(
            0xd800 + (i &gt;&gt; 10),
            0xdc00 + (i &amp; 0x3FF));
    } else <span class="cstat-no" title="statement not covered" >if (i == i) {</span>
<span class="cstat-no" title="statement not covered" >      return String.fromCharCode(i);</span>
    } else <span class="cstat-no" title="statement not covered" >if (s[1] &lt; ' ') {</span>
      // "a backslash followed by a newline is ignored".
<span class="cstat-no" title="statement not covered" >      return '';</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return s[1];</span>
    }
  }
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  function escapeCssString(s, replacer) {</span>
<span class="cstat-no" title="statement not covered" >    return '"' + s.replace(/[\u0000-\u001f\\"&lt;&gt;]/g, replacer) + '"';</span>
  }
&nbsp;
  /**
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  function escapeCssStrChar(ch) {</span>
<span class="cstat-no" title="statement not covered" >    return cssStrChars[ch]</span>
...
&nbsp;
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  function escapeCssUrlChar(ch) {</span>
<span class="cstat-no" title="statement not covered" >    return cssUrlChars[ch]</span>
...
&nbsp;
   ...
   */
   decodeCss = <span class="fstat-no" title="function not covered" >function (css) {</span>
<span class="cstat-no" title="statement not covered" >     return css.replace(</span>
...
&nbsp;
   ...
   */
  lexCss = <span class="fstat-no" title="function not covered" >function (cssText) {</span>
<span class="cstat-no" title="statement not covered" >    cssText = '' + cssText;</span>
<span class="cstat-no" title="statement not covered" >    var tokens = cssText.replace(/\r\n?/g, '\n')  // Normalize CRLF &amp; CR to LF.</span>
        .match(CSS_TOKEN) || [];
...
<span class="cstat-no" title="statement not covered" >    for (var i = 0, n = tokens.length; i &lt; n; ++i) {</span>
...
<span class="cstat-no" title="statement not covered" >      var tok = decodeCss(tokens[i]);</span>
<span class="cstat-no" title="statement not covered" >      var len = tok.length;</span>
<span class="cstat-no" title="statement not covered" >      var cc = tok.charCodeAt(0);</span>
<span class="cstat-no" title="statement not covered" >      tok =</span>
...
<span class="cstat-no" title="statement not covered" >      if (last != tok || tok != ' ') {</span>
<span class="cstat-no" title="statement not covered" >        tokens[j++] = last = tok;</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    tokens.length = j;</span>
<span class="cstat-no" title="statement not covered" >    return tokens;</span>
  };
})();
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function(css) {</span>
<span class="cstat-no" title="statement not covered" >  var tokens = lexCss(css);</span>
<span class="cstat-no" title="statement not covered" >  var result = '', match;</span>
<span class="cstat-no" title="statement not covered" >  for(var i=0; i&lt;tokens.length, token=tokens[i]; i++) {</span>
<span class="cstat-no" title="statement not covered" >    result += token;</span>
  }
  // console.log(result, "\n\n");
